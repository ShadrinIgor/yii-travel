...
return array(
    ...
    "Статистика посещаемости" => "statistics",
    "Просмотреть страницу фирмы" => "iew page of the company",
    "Посмотреть как будет выглядеть персональная страница фирмы" => "View will look like personalized page of the company",
    "Добавить тур для Вашей компания" => "Add a tour for your company",
