...
<?php foreach( $items as $item ):
    ...
    <tr <?= $item->is_hot==1 ? 'class="isHot"' : "" ?>>
        <td><?= $item->id ?></td>
        <td>
            <a href="<?= SiteHelper::createUrl( "/user/work/description", array("id"=>$item->id) ) ?>" title="описание"><?= $item->name ?></a>
        </td>
...
<?php endforeach; ?>
    ...
    <br/>
    <center>
        <a href="<?= SiteHelper::createUrl("/user/work/description") ?>">Добавить вакансию</a>
    </center>
</div>