<div id="innerPage">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        <table class="tableForm">
            ...
            ?>
            <tr>
                <th><?= Yii::t("user", "Расместить на главной"); ?></th>
                <td>
                    <?php if( !$checkedRequest ) : ?>
                        ...
                        <?php else : ?>
                            ...
                            <div class="errorSummary"><?= Yii::t("user", "К сожалению все завяки уже заняты, и сейчас Вы не можете разместить Свой баннер, через 10 дней будут приниматся новые завки, не <b>УПУСТИТЕ МОМЕНТ</b>"); ?> </div>
                        <?php endif; ?>
                    <?php else: ?>
