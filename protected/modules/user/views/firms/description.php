...
<h1>Описание фирмы</h1>
    <div id="dopMenu">
        <a href="#">Галлерея</a>
        <a href="#">Описание</a>
        <a href="#">Туры компаниии</a>
        <a href="#" title="Посмотреть как будет выглядеть персональная страница фирмы">Просмотреть страницу фирмы</a>
    </div>
...
<?php endif; ?>
    <div id="firmTours">
        ...
        <?php
            $listTours = CatalogTours::fetchAll( DBQueryParamsClass::CreateParams()->setConditions("firm_id=:firm_id")->setParams( array( ":firm_id"=>$item->id ) ) );
            ...
            <tr <?= $tour->hot==1 ? 'class="isHot"' : "" ?>>
                ...
                <td>
                    <a href="<?= SiteHelper::createUrl( "/user/tours/description", array("fid"=>$tour->id) ) ?>" title="описание"><?= $tour->name ?></a>
                </td>
                ...
                <td class="textAlignCenter">
                    ...
                    <div class="itemAction textAlignCenter">
                        ...
                        <div class="popup PMarginLeft">
                            ...
                            <a href="<?= SiteHelper::createUrl("/user/tours/delete", array("id"=>$tour->id, "fid"=>$item->id)) ?>">Удалить</a>
                        </div>
