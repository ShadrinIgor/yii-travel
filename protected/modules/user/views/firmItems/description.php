<div id="innerPage">
    ...
    $this->widget('addressLineWidget', array(
        'links'=>array(
            ...
            Yii::t("user", "список акций компании") => SiteHelper::createUrl( "/user/firms/description/", array( "id"=>$firm->id, "tab"=>"items" ) ),
            $firm->id > 0 ? $firm->name : Yii::t("user", "Описание тура")
        ),
    ));
    ?>
    <h1><?= Yii::t("user", "Описание акции/скидки"); ?></h1>
    <div id="dopMenu" class="tourPage">
        ...
        <a href="<?= SiteHelper::createUrl( "/user/firms/description/", array( "id"=>$firm->id, "tab"=>"items" ) ) ?>">><?= Yii::t("user", "вернуться к списку акций") ?></a>
        <?php if( $item->id >0 ) : ?>
