...
class FirmServiceController extends UserController
{
    var $firmId;
    ...
    {
        $_POST["CatalogFirmsServiceAdd"]["firm_id"] = $this->firmId;
        $_POST["CatalogFirmsServiceAdd"]["user_id"] = Yii::app()->user->getId();
