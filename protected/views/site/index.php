...
?>
    <p>
        Главной целью, с которой мы создавали наш сайт, было, есть и будет обеспечение наших пользователей оперативной, достоверной и проверенной информацией в максимальных объёмах как тем пользователям интернета, которые планируют проведение очередного своего отпуска и хотят выбрать наиболее приемлемый вариант, так и тем пользователям, для которых туристический бизнес является основной сферой их деятельности.
        Для потребителей туристических услуг  нами разработан удобный интерфейс. Данный интерфейс позволит вам в самые короткие сроки отыскать тур, страну или отель отвечающие в полной мере запросам клиента. Для осуществления поиска, вам достаточно ввести информацию об интересующей вас стране и категории выбранного вами отдыха в поисковик. Поисковик расположен на странице в левом верхнем углу.
        Для обеспечения комфортного самочувствия тем, для кого туристический бизнес является основным видом деятельности, нами разработана удобная система, позволяющая любому заинтересованному лицу, будь он юридическим или  физическим производить самостоятельное размещение на страницах нашего туристического сайта максимального количества вашей информации. Осуществление этой операции не требует затрат времени в большом количестве и не повлечёт за собой затрат материальных. Иными словами, данная услуга предоставляется совершенно бесплатно.
        Чтобы поместить информацию достаточно выполнение несложной процедуры регистрации, которая позволит вам, руководствуясь подсказками, которые размещены нами в большом количестве, выложить информацию именно в том нашем разделе, который вас заинтересовал в большей мере.
        Мы постоянно готовы к сотрудничеству в любых его формах и будем благодарны за высказанные в наш адрес замечаниями, касающимися как организации нашей работы, так и предложений, касающихся совместной деятельности.
    </p>
    <div id="Buttons">
