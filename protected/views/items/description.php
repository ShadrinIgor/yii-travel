    ...
    <?php if( sizeof($firmsItems)>0 ) : ?>
        ...
        <div class="ITBlock">
            ...
            <div class="textAlignRight">
                <a href="<?= SiteHelper::createUrl("/sales/description")."/".$item->slug ?>.html" class="cmore" title="<?= Yii::t("page", "все акции/скидки"); ?> <?= $item->firm_id->name ?>"><?= Yii::t("page", "все акции/скидки"); ?> <?= $item->firm_id->name ?></a>
            </div>
        </div>
    <?php endif; ?>
</div>