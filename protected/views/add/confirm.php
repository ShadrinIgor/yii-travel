...
<div id="InnerText" class="innerPage">
    ...
    <div class="greeBorder">
        ...
        <p>
            ...
            <?= Yii::t("add", "вы можете БЕСПЛАТНО добавить инфомацию о Вашей туристической фирме, о вашем отеле, зоне отдыха"); ?><br>
            <?= Yii::t("add", "Например: Ваши услуги, рекламный баннер, туры, спец предложениея, акции... "); ?><br>
            <a href="<?= SiteHelper::createUrl("/add") ?>" title="<?= Yii::t("add", "Добавить туристическую информаци бесплатно"); ?>"><?= Yii::t("add", "Добавить туристическую информаци бесплатно"); ?></a>
        </p>
    </div>
</div>
