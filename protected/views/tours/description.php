...
<div id="InnerText">
    ...
    <div id="ITText">
        ...
        <div class="LParams">
            ...
            категория:<a href="<?= SiteHelper::createUrl("/tours")."/".$item->category_id->slug ?>" title="<?= SiteHelper::getTranslateForUrl( $item->category_id->name ) ?>"><?= $item->category_id->name ?></a><br/>
            фирма: <a href="<?= SiteHelper::createUrl("/firms/description")."/".$item->firm_id->slug ?>" title="<?= SiteHelper::getTranslateForUrl( $item->firm_id->name ) ?>"><?= $item->firm_id->name ?></a><br/>
            <br/>
