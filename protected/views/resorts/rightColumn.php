<div id="Cleft">
    <div class="LeftMenu">
        ...
        <ul>
            ...
            ?>
            <li><a href="<?= SiteHelper::createUrl("resorts/", array("category_id"=>$item_->id)) ?>" title="<?= $item_->name ?> туры"><?= $item_->name ?> ( <?= $count ?> )</a>
                <ul>
                <?php
            ...
            ?>
                    ...
                    <?php if( $count>0 ) : ?><li><a href="<?= SiteHelper::createUrl("resorts/", array("category_id"=>$item->id)) ?>" title="<?= $item->name ?> туры"><?= $item->name ?> ( <?= $count ?> )</a></li><?php endif; ?>
                <?php endforeach; ?>
                </ul>
            </li>
            <?php endforeach; ?>
