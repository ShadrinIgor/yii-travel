...
class SectionsController extends Controller
{
    ...
    {
        parent::init();
        $this->description = Yii::t("sections", "Разновидности турестического отдыха такие как экстрим, охота и рыбалка, иследования, религия, детские лагеря, отдых в горах");
        $this->keyWord = Yii::t("sections", "Эктримальный туризм, Охота и рыбалка, VIP отдых, Развлекательный туризм, Исследовательский туризм, Религиозный туризм, Детские лагеря, Отдых в горах");
    }
