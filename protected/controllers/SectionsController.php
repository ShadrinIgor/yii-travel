...
class SectionsController extends Controller
{
    ...
    {
        parent::init();
        $this->description = Yii::t("sections", "Разновидности туристического отдыха такие как экстрим, охота и рыбалка, исследование, религия, детские лагеря, отдых в горах");
        $this->keyWord = Yii::t("sections", "Экстремальный туризм, Охота и рыбалка, VIP отдых, Развлекательный туризм, Исследовательский туризм, Религиозный туризм, Детские лагеря, Отдых в горах");
    }
