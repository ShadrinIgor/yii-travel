...
class HotelsController extends InfoController
{
    public function init()
    {
        ...
        $this->classCategory = "";
        $this->description = Yii::t("hotel", "Самые популярные о/тели мира, отсортированные по рейтингу. возможность просмотра подробного описания" );
        $this->keyWord = Yii::t("hotel", "Полезная информация для туристов, архитектура, базары Узбекистана, банки Ташкента, великие люди, великий шелковый путь, автобусные путешествия, виза в Узбекистан, дети, культура / искусства, разновидности туризма, экстремальный  туризм , рыбалка/охота, религия / духовные центры, кладбища" );
    }
