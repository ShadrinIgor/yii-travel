...
class ResortsController extends InfoController
{
    public function init()
    {
        ...
        $this->description = Yii::t("resorts", "Самые популярные курорты, зоны отдыха, дестские лагеря, отсортированные по рейтингу. возможность просмотра подробного описания, галлереи, дополнительных услуг цен и возможность отправить заказ");
