...
*/
    ...
    protected $notificationsActions; //  NotificationsActions
	...
	public function relations()
	{
		...
		return array(
			'notifications' => array(self::HAS_MANY, 'Notifications', 'type_id'),
			'notificationsActions' => array(self::HAS_MANY, 'NotificationsActions', 'type_id'),
		);
	}
