...
*/
	...
	public function rules()
	{
		...
		return array(
			array('type_id, user_id, message, subject', 'required'),
			array('date, del, item_id, is_new', 'numerical', 'integerOnly'=>true),
			array('catalog', 'length', 'max'=>50),
            array('type_id, user_id, date, del, action_id, item_id, catalog, is_new, message, subject', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, type_id, user_id, date, del, action_id, item_id, catalog, is_new', 'safe', 'on'=>'search'),
		);
	}
