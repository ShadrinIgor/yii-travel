...
/**
 * This is the model class for table "catalog_info_category_Ja".
   */
class CatalogInfoCategoryJa extends CCModel
{
...
*/
	...
	{
		return 'catalog_info_category_ja';
	}
	...
	public function relations()
	{
		...
		return array(
			'owner0' => array(self::BELONGS_TO, 'CatalogInfoCategoryJa', 'owner'),
			'catalogInfoCategoryJas' => array(self::HAS_MANY, 'CatalogInfoCategoryJa', 'owner'),
		);
	}
