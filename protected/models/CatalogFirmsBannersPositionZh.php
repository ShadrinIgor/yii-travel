...
/**
 * This is the model class for table "catalog_firms_banners_position_zh".
   */
class CatalogFirmsBannersPositionZh extends CCModel
{
...
*/
	...
	{
		return 'catalog_firms_banners_position_zh';
	}
