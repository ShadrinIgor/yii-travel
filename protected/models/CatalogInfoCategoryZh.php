...
/**
 * This is the model class for table "catalog_info_category_zh".
   */
class CatalogInfoCategoryZh extends CCModel
{
...
*/
	...
	{
		return 'catalog_info_category_zh';
	}
	...
	public function relations()
	{
		...
		return array(
			'owner0' => array(self::BELONGS_TO, 'CatalogInfoCategoryZh', 'owner'),
			'catalogInfoCategoryJas' => array(self::HAS_MANY, 'CatalogInfoCategoryZh', 'owner'),
		);
	}
