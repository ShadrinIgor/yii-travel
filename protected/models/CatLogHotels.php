...
/**
 * This is the model class for table "cat_log_hotels".
   */
class CatLogHotels extends CCModel
{
...
*/
	...
	public function rules()
	{
		...
		return array(
			array('hotel_id, date_from', 'required'),
			array('hotel_id, action_show, action_contact, action_showimage, name, del, pos, date_from, date_to', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, hotel_id, action_show, action_contact, action_showimage, name, del, pos, date_from, date_to', 'safe'),
            array('id, hotel_id, action_show, action_contact, action_showimage, name, del, pos, date_from, date_to', 'safe', 'on'=>'search'),
		);
	}
