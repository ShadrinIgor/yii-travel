...
/**
 * This is the model class for table "catalog_kurorts_en".
   */
class CatalogKurortsJa extends CCModel
{
...
*/
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, pos, del, firms_count, col', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, description, pos, country_id, city_id, image, del, location, www, email, telefon, price, firms_count, col, category_id, slug, user_id, active', 'safe'),
            array('id, name, description, pos, country_id, city_id, image, del, location, www, email, telefon, price, firms_count, col, category_id, slug, user_id, active', 'safe', 'on'=>'search'),
		);
	}
