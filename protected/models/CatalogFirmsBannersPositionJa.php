...
/**
 * This is the model class for table "catalog_firms_banners_position_Ja".
   */
class CatalogFirmsBannersPositionJa extends CCModel
{
...
*/
	...
	{
		return 'catalog_firms_banners_position_ja';
	}
