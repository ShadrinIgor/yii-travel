...
/**
 * This is the model class for table "catalog_items_zh".
   */
class CatalogItemsZh extends CCModel
{
...
*/
	...
	public function rules()
	{
		...
		return array(
			array('id, name, description, user_id, type_id', 'required'),
			array('del, price, is_hot, date, pos, col', 'numerical', 'integerOnly'=>true),
			array('name, image', 'length', 'max'=>255),
			array('slug', 'length', 'max'=>150),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, name, image, description, del, price, user_id, category_id, type_id, status_id, is_hot, date, city_id, pos, time_id, slug, col', 'safe'),
	...
	public function relations()
	{
		...
		return array(
			'category' => array(self::BELONGS_TO, 'CatalogItemsZhCategory', 'category_id'),
			'status' => array(self::BELONGS_TO, 'CatalogItemsZhStatus', 'status_id'),
