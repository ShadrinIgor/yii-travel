...
<?php if( $type == "add_firm_dig" ) : ?>
    <div class="B01">
        <a href="<?= SiteHelper::createUrl("/add") ?>/travel-agency" title="Добавить туристическую фирму, бесплатная реклама ">
            ...
            <br/>
            вы можете БЕСПЛАТНО добавить информацию о Вашей туристической фирме, о вашем отеле, зоне отдыха <br/>
            Например: Ваши услуги, рекламный баннер, туры, спец предложения, акции...
        </a>
    </div>
<?php endif; ?>
