<?php foreach( $items as $item ) :
    ...
    <div class="listItems">
        ...
        <div class="LParams">
            ...
            <a href="<?= SiteHelper::createUrl("/tours/description")."/".$item->category_id->slug ?>.html" title="<?= $item->category_id->name ?>"><?= Yii::t("page", "Категория"); ?>: <b><?= $item->category_id->name ?></b></a><br/>
        </div>
