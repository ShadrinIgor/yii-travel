<?php foreach( $items as $item ) :
    ...
    <div class="listItems">
        ...
        <div class="LParams">
            ...
            <a href="<?= SiteHelper::createUrl("firms/description", array( "id"=>$item->firm_id->id )) ?>" title="<?= $item->firm_id->name ?>">Фирма: <b><?= $item->firm_id->name ?></b></a><br/>
            ...
            <a href="<?= SiteHelper::createUrl("tours/description", array( "category"=>$item->category_id->id )) ?>" title="<?= $item->category_id->name ?>">Категория: <b><?= $item->category_id->name ?></b></a><br/>
        </div>
