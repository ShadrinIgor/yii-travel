...
<div class="IBItem">
    ...
    <div class="LParams">
        <a href="<?= SiteHelper::createUrl("/travelAgency/description")."/".$tour->firm_id->slug ?>.html" title="туристическая фирма <?= SiteHelper::getStringForTitle( $tour->firm_id->name ) ?>"><?= $tour->firm_id->name ?></a>
    </div>
</div>
