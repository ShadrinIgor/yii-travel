...
<?php endif; ?>
<br/>
<a href="<?= SiteHelper::createUrl( "/site/sales" ) ?>" class="addButton" title="<?= Yii::t("trainings", "Разместить Акцию/Скидку/Спец. прдложение компании"); ?>"><?= Yii::t("trainings", "Разместить Акцию/Скидку компании"); ?></a>
<br/>
