<?php foreach( $items as $item ) :
    ...
    <div class="listItems">
        ...
        <div class="LParams">
            ...
            <a href="<?= SiteHelper::createUrl("/travelAgency")."/".$item->firm_id->slug ?>.html" title="<?= $item->firm_id->name ?>"><?= Yii::t("page", "Фирма"); ?>: <b><?= $item->firm_id->name ?></b></a><br/>
            ...
            <a href="<?= SiteHelper::createUrl("/tours")."/".$item->category_id->slug ?>.html" title="<?= $item->category_id->name ?>"><?= Yii::t("page", "Категория"); ?>: <b><?= $item->category_id->name ?></b></a><br/>
        </div>
    </div>
<?php
endforeach;