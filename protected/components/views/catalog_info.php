...
foreach( $items as $item ) :
    ...
    <div class="listItems">
        ...
        <div class="LParams">
            ...
            <?php if( $item->category_id ) : ?><a href="<?= SiteHelper::createUrl("resorts/", array( "category_id"=>$item->category_id->id )) ?>" title="<?= $item->category_id->name ?>"><b><?= $item->category_id->name ?></b></a><br/><?php endif; ?>
            <?php if( $item->country_id ) : ?><a href="<?= SiteHelper::createUrl("country/", array( "slug"=>$item->country_id->slug )) ?>" title="<?= $item->country_id->name ?>">Страна: <b><?= $item->country_id->name ?></b></a><br/><?php endif; ?>
