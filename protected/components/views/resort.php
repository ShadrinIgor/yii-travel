<div class="IBItem">
    ...
    <div class="LParams">
        ...
        <?php if( $item->category_id ) : ?><a href="<?= SiteHelper::createUrl("/resorts/category")."/".$item->category_id->slug ?>.html" title="зоны отдыха <?= $item->category_id->name ?>"><?= $item->category_id->name ?></a><?php endif; ?>
    </div>
</div>
