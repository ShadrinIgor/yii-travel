...
*/
        ...
        'db'=>array(
            'connectionString' => 'mysql:host=localhost;dbname=cms_catalogkz_yii',
            'emulatePrepare' => true,
...
*/
	...
	'params'=>array(
		...
		'adminEmail'=>'info@catalogkz.world-news.uz',
        'baseUrl' => 'http://catalogkz.world-news.uz/',
        'images' => array(
            "default" => array(
        ...
        "catalogList"=>array(
                    ...
                    "CatalogItemsType" => "Типы объявлений",
                    "CatalogItemsStatus" => "Статусы объявлений",
                    "CatalogDesktops"    => "Рабочие столы",
                    "CatalogServices"    => "Услуги и цены",


                    // Параметры
                    "CatalogItemsValuesColor" => "Цвет",
                    "CatalogItemsValuesShini" => "Шины",
                    "CatalogItemsValuesSostoyanie" => "Состояние",
                    "CatalogItemsValuesTipkuzova" => "Тип кузова",
                    "CatalogItemsValuesToplivo" => "Топливо",
                    "CatalogItemsValuesType" => "Тип",
                    "CatalogItemsValuesDiski" => "Диски",
                    "CatalogItemsValuesDvigtip" => "Тип двигателя",
                    "CatalogItemsValuesKpp" => "КПП",
                    "CatalogItemsValuesMarka" => "Марка",
                    "CatalogItemsValuesModel" => "Модель",
                    "CatalogItemsValuesNalichie" => "Наличие",
                    "CatalogItemsValuesPrivod" => "Привод",
                    "CatalogItemsValuesSalon" => "Салон",
